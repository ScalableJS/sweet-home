...
* **Смеситель:** Термостатический (bateria termostatyczna) с блокировкой температуры на 38°C
* **Выконьчение (цвет):** Хром (chrom)
...
* Верхний душ (deszczownica) + ручной душ (słuchawka prysznicowa).
...
* **Выконьчение (цвет):** Матовая сталь (stal szczotkowana)
...
* Шланг с системой **Anti-twist** (защита от перекручивания węża).
...
| **Цвет / Покрытие** | Матовая сталь (stal szczotkowana) | Хром (chrom) |
